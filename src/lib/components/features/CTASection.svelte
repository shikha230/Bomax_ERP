<script lang="ts">
  import { Rocket, Calendar, Headphones, Check } from 'lucide-svelte';
...
>
  ...
  <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
    <!-- Badge -->
    <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-white/90 mb-8 shadow-sm backdrop-blur-sm">
      <Rocket class="h-3.5 w-3.5 text-blue-200" />
      <span class="text-xs font-bold font-jakarta tracking-wide">Get Started Today</span>
    </div>
