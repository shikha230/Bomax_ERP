  ...
  <div class="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8 h-20">
    ...
    <div class="hidden md:flex items-center gap-4">
      ...
      >
        ...
        <div class="absolute inset-0 -translate-x-full group-hover/btn:translate-x-0 bg-linear-to-r from-blue-600 to-cyan-500 transition-transform duration-300 ease-out"></div>
      </a>
    </div>
...
{#if mobileMenuOpen}
  ...
  <!-- Mobile Drawer Menu -->
  <div
    class="fixed top-20 bottom-0 right-0 z-50 w-full max-w-70 border-l border-slate-100 bg-white p-6 shadow-2xl md:hidden overflow-y-auto"
  >
    <div class="flex flex-col gap-6">
      ...
      <div class="flex flex-col gap-3">
        ...
        <a
          href="#demo"
          class="flex w-full items-center justify-center rounded-xl bg-blue-600 py-2.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition-all duration-200"
          onclick={() => mobileMenuOpen = false}
        >
          Book Live Demo
        </a>
